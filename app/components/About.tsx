      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-4 border-r border-neutral-300 dark:border-neutral-700">
          ...
          <p className="leading-8 mb-6">
            ...
            <span className="font-bold">Génie industriel</span>
            {` de l'Institut
        ...
        <div className="flex-1 p-4">
          ...
          <p className="leading-8 mb-6">
            ...
            <span className="font-bold">bases de la programmation</span>
            {`, les `}
            <span className="font-bold">algorithmes</span>
            {`, ainsi que la `}
            <span className="font-bold">
              programmation procédurale et orientée objet
            </span>
            {`. J'ai également étudié les `}
            <span className="font-bold">design patterns</span>
            {` et les `}
          ...
          <p className="leading-8 mb-6">
            ...
            <span className="font-bold">gestion de paie</span>
            {` avec React et
          ...
          <p className="leading-8">
            ...
            <span className="font-bold">Licence en informatique</span>
            {` au Centre
